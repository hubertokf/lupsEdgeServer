...
class EngineRule(object):
    ...
    #url = 'http://localhost:8000/rules/{0}/?format=json'.format(a) # quando o servidor estiver em funcionamento
        url = 'http://localhost:8000/rules/?format=json&id_of_sensor={0}'.format(a) # a fins de teste
    ...
    def run_rules(self,a): # executa a regra
        ...
        obj_parameters= Parameters(parameters['id'],parameters['valor'],parameters['id_gateway'],parameters['contador']) #id_gateway futuramente será trabalhado
