...
def post_save_sched(sender, instance, created, **kwargs):
    data =  {"id": str(instance.id),"status": str(instance.status),"year": str(instance.year),"month": str(instance.month),"day": str(instance.day),"hour": str(instance.hour),"minute": str(instance.minute),"sensor": str(instance.sensor.id),"signal":"saved"}
